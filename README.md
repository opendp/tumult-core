...
> - Releasing this software under an [OSI approved license](https://opensource.org/licenses), in this case the [Apache License](https://github.com/opendp/tumult-core/blob/main/LICENSE).
